package com.mycompany.demandes.config;

import com.mycompany.demandes.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.mycompany.demandes.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.mycompany.demandes.repository.search")
